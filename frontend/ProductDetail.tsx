...
export default function ProductDetail({
  ...
  return (
    <div
      ref={scrollRef}
      className="relative h-screen overflow-y-scroll bg-gray-50 pb-32 [&::-webkit-scrollbar]:hidden"
    ...
    >
      ...
      {/* ── 5. Sticky Footer ─────────────────────────────────────────────────── */}
      <footer className="fixed bottom-0 left-0 right-0 z-50 bg-white px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-3 shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
