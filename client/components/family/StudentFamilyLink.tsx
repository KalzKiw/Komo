    ...
    return (
      <div className="flex h-full flex-col items-center justify-center bg-gray-50 px-6 py-8">
        <div className="w-full max-w-sm overflow-hidden rounded-3xl bg-white shadow-sm">
          {/* Green header */}
          <div className="flex flex-col items-center bg-emerald-600 px-6 pb-8 pt-8">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white/20">
              <CheckCircle className="h-8 w-8 text-white" />
            </div>
            <h2 className="mt-3 text-xl font-bold text-white">Cuenta vinculada</h2>
            <p className="mt-1 text-sm text-emerald-100">La vinculación familiar está activa</p>
          </div>
        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-sm">
          ...
          <div className="px-5 pb-5">
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-2xl bg-emerald-600 py-3.5 font-bold text-white transition-all hover:bg-emerald-700 active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-50"
            >
              {submitting ? (
